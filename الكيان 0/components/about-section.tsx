      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mx-auto max-w-3xl rounded-xl bg-secondary p-6 text-center md:p-8">
          <p className="leading-relaxed text-secondary-foreground">
            {"كيان الشباب بناة المستقبل هو منظمة شبابية تهدف إلى بناء جيل من القادة المبدعين من خلال تقديم برامج تدريبية متخصصة، مبادرات مجتمعية فعالة، وأنشطة تطويرية شاملة. نؤمن بأن الشباب هم عماد المستقبل ونعمل على تزويدهم بالمهارات والأدوات اللازمة لتحقيق طموحاتهم وخدمة مجتمعاتهم."}
          </p>
        </div>
      </div>
    </section>
